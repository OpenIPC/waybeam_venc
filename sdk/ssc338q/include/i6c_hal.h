...
int i6c_select_sensor_mode(short requested_width, short requested_height,
    unsigned char requested_fps, char *sensor_index, short *sensor_width,
    short *sensor_height, unsigned char *sensor_fps);
