...
static int maruko_apply_gop(uint32_t gop_size)
{
	...
	if (maruko_mi_venc_get_chn_attr(g_ctx.venc_dev,
		...
		return -1;
	switch (attr.rate.mode) {
	case MARUKO_RC_H265_CBR: attr.rate.h265Cbr.gop = gop_size; break;
	case MARUKO_RC_H264_CBR: attr.rate.h264Cbr.gop = gop_size; break;
	case MARUKO_RC_H265_VBR: attr.rate.h265Vbr.gop = gop_size; break;
	case MARUKO_RC_H264_VBR: attr.rate.h264Vbr.gop = gop_size; break;
	case MARUKO_RC_H265_AVBR: attr.rate.h265Avbr.gop = gop_size; break;
	case MARUKO_RC_H264_AVBR: attr.rate.h264Avbr.gop = gop_size; break;
	default: return -1;
	}
	return maruko_mi_venc_set_chn_attr(g_ctx.venc_dev,
		g_ctx.venc_chn, &attr) == 0 ? 0 : -1;
...
static uint32_t maruko_query_live_fps(void)
{
	...
	switch (attr.rate.mode) {
	case MARUKO_RC_H265_CBR: return attr.rate.h265Cbr.fpsNum;
	case MARUKO_RC_H264_CBR: return attr.rate.h264Cbr.fpsNum;
	case MARUKO_RC_H265_VBR: return attr.rate.h265Vbr.fpsNum;
	case MARUKO_RC_H264_VBR: return attr.rate.h264Vbr.fpsNum;
	case MARUKO_RC_H265_AVBR: return attr.rate.h265Avbr.fpsNum;
	case MARUKO_RC_H264_AVBR: return attr.rate.h264Avbr.fpsNum;
	default: return 0;
	}
}
