...
static struct { // LINEAR
     ...
     * Mode 3: 1920x1080@90fps — Star6E windowed (HMAX=275, verified 89fps)
     *          Sensor supports 120fps but ISP stalls at >90fps input.
     *          VTS clamp at 120fps also fails (ISP overflow → zero frames). */
...
static int pCus_SetVideoRes(ms_cus_sensor* handle, u32 res_idx)
{
    ...
    case 3: // 1920x1080@90fps — windowed (Star6E 120fps table, ISP max ~90fps)
